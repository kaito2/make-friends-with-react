...
const Accordion = (props: AccordionProps) => {
  return (
    <AccordionPrimitive.Root
      type="single"
      defaultValue="item-1"
      className={clsx("space-y-4 w-1/2 mt-4")}
    >
          ...
          <AccordionPrimitive.Header className="w-full">
            <AccordionPrimitive.Trigger
              className={clsx(
                ...
                "focus:outline-none",
                "w-full inline-flex justify-between bg-white px-4 py-2 text-left dark:bg-gray-800"
              )}
            >
              ...
              <ChevronDownIcon
                className={clsx(
                  "h-5 w-5 shrink-0 text-gray-700 ease-in-out dark:text-gray-400",
